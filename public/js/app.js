...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    submit: function submit() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/api/login", _objectSpread({}, this.formData)).then(function (res) {
        var token = res.data;
        var storage = _this.rememberMe ? localStorage : sessionStorage;
        ...
        if (((_err$response = err.response) === null || _err$response === void 0 ? void 0 : _err$response.status) === 422) {
          ...
          Object.keys(errorBag).forEach(function (key) {
            return errors.push.apply(errors, _toConsumableArray(errorBag[key]));
          });
        } else {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    LoginPage: _LoginComponent__WEBPACK_IMPORTED_MODULE_0__["default"],
    MainPage: _MainComponent__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  ...
  return _c(
    ...
    [
      ...
      _vm._l(_vm.errors, function(error, key) {
        return _c("div", { key: key, staticClass: "error" }, [
          _vm._v(_vm._s(error))
        ])
      }),
      _vm._v(" "),
...
var render = function() {
  ...
  return _c(
    ...
    [
      _vm.token !== null
        ? _c("main-page")
        : _c("login-page", { attrs: { setToken: _vm.setToken } })
    ],
    1
  )
}
...
__webpack_require__(/*! /Users/firebain/Desktop/Sites/url_shortener/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/firebain/Desktop/Sites/url_shortener/resources/sass/app.scss */"./resources/sass/app.scss");
