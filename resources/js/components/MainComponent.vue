<template>
  <form @submit.prevent="submit">
    <div class="form-group row">
      <label for="url" class="col-md-4 col-form-label text-md-right">Enter your URL here</label>
    ...
    <div class="form-group row" v-if="short !== null">
      <label class="col-md-4 col-form-label text-md-right">Your shortened URL</label>
